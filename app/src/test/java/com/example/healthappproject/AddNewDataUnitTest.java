...
public class AddNewDataUnitTest {
    ...
    public void testAddData() {
        ...
        NewRecord data1 = new NewRecord(75,130,72,"Id1","New Comment1",date);
        dataList.addData(data1);
        assertEquals(1, dataList.getData().size());

        NewRecord data2 = new NewRecord(80,140,67,"Id2","New Comment2",date);
    ...
    public void testDeleteData() {
        ...
        AddNewDataClass dataList = new AddNewDataClass();
        NewRecord data1 = new NewRecord(77,132,74,"Id3","New Comment3",date);
        dataList.addData(data1);
        assertEquals(1, dataList.getData().size());

        NewRecord data2 = new NewRecord(82,138,65,"Id4","New Comment4",date);
        dataList.addData(data2);
        assertEquals(2, dataList.getData().size());
    ...
    public void testAddRecordException() {
        ...
        AddNewDataClass dataList = new AddNewDataClass();
        NewRecord data1 = new NewRecord(76,133,72,"Id5","New Comment5",date);
        dataList.addData(data1);
    ...
    public void testDeleteRecordException() {
        ...
        AddNewDataClass dataList = new AddNewDataClass();
        NewRecord data1 = new NewRecord(79,136,74,"Id6","New Comment6",date);
        dataList.addData(data1);
