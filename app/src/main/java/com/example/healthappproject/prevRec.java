...
public class prevRec extends AppCompatActivity {
    LinearLayoutManager linearLayoutManager;
    List<NewRecord> dataList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prev_rec);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(prevRec.this, R.layout.menu_item, s);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                Intent intent = new Intent(prevRec.this, homepage.class);
...
//                    id=dataSnapshot.child("id").getValue(String.class);
                    ...
                    initData1(new NewRecord(systolic, diastolic, hrateint, id1, comment, date));
                }
                //TextView t=findViewById(R.id.UserData);
                //t.setText(""+dataList.get(0).getSystolic()+""+dataList.get(1).getSystolic());
                if (p == 0) {
                    Collections.sort(dataList, new Comparator<NewRecord>() {
                        /**
                         ...
                         */
                        @Override
                        public int compare(NewRecord addNewData, NewRecord t1) {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(prevRec.this, " " + error.toString(), Toast.LENGTH_SHORT).show();
            }
        });
     ...
     * @param a
     */
    private void initData1(NewRecord a) {
        dataList.add(a);
    }
    ...
    private void initRecyclerView1(int p) {
        ...
        linearLayoutManager = new LinearLayoutManager(prevRec.this);
        linearLayoutManager.setOrientation(RecyclerView.VERTICAL);
        recyclerView.setLayoutManager(linearLayoutManager);
        adapter = new Adapter_Stat(dataList, prevRec.this);
